...
app.post('/webhook', async (req, res) => {
  ...
  try {
    ...
    if (evt.type === 'user.created') {
      const email = Array.isArray(evt.data.email_addresses) && evt.data.email_addresses.length > 0
        ? evt.data.email_addresses[0].email_address || evt.data.email_addresses[0]
        : '';
